...
<div class="fcn-grid" style="cursor: auto;">
		                                ...
		                                <div class="editor layoutCollapsed__3p1JrXw3YdUkz-6Oxzh7JF">
		                                    ...
		                                    <div class="editor-container">
		                                        <div class="editor__tkUjOZxm52udSrxaZUvoy defaults__1l9bk0Z91YqvzRByZKNgHF cc__1zsV8w8Rj_vs2ayVLJ-2x cmeditor__2Gxggo8GsvlSZS4rMGa1zE">
													<textarea id="editor" style="display: none;"><c:if test="${TEMP_CODE == null}">${SELECTED_QUESTION.defaultCode}</c:if><c:if test="${TEMP_CODE != null}">${TEMP_CODE}</c:if></textarea>
		                                        </div>
		                                    </div>
		                                    <textarea style="display: none;" id="default-code">${SELECTED_QUESTION.defaultCode}</textarea>
		                                        ...
		                                        <div class="fcn-tabs-container">
		                                            <div class="editor-footer__buttons">
		                                                <div class="editorFooter__3vMXEva7_RFPU2uMCO-X_H">
		                                                    ...
		                                                    <div id="reset-code" class="ResetWorkspaceControl__88z6jsIn6PfE5Pau4k-ll" style="opacity: 1; margin-top: 0px;"><span class="cta__2mjuuxJjh22qJC_GiTMSh7">Khôi phục mã gốc</span>
		                                                        <div class="ctaArrow__h5q8WAhe0BF1Ki1ae5bVq"></div><span class="fcn-tabs__tab fcn-button fcn-button--tab fcn-button--tab--inactive fcn-control" style="max-width: 200px;"><img style="width: 16px; margin-left: 8px; margin-top: 2px;" src="<c:url value="/Resources/Home/img/reset.png" />" /></span></div>
		                                                    <div class="copyContentControl__2_nJWm5SAnjrPglBWCDFCU" style="opacity: 1; margin-top: 0px;" onclick="copy('#editor')"><span class="cta__11uZvWt-AkTuaIfgAOUIFu">Sao chép vào bộ nhớ đệm</span>
		            ...
		            var editor = CodeMirror.fromTextArea(document.getElementById("editor"), {
					  ...
					  $("#reset-code").click(function(e) {
							if(confirm('Khôi phục mã gốc?')) {
								 var textArea = document.getElementById('default-code').value.replace(/\r\n/g, '\r\n').replace(/\n/g, '\n').replace(/\r/g, '\r').replace(/\t/g, '\t');
								 editor.getDoc().setValue(textArea);
						  	}
					  });
