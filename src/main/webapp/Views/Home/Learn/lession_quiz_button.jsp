...
<c:choose>
	<c:when test="${IS_DONE != null && IS_DONE == true && IS_TRUE == true}">
		<div class="container__36jSDfZIHaBt6OZ7dpxSd8">
			    ...
			    <div class="container__2ZkNUvVpS2bqFetXuLBHoA">
			        ...
			        <div id="answer" class="checkAnswer__3C7xBIy14T7r2Ayg-nFIAJ" style="z-index: 100;">
			            <button id="view-result" data-btn="true" data-testid="check-answer-cta" class="basicBtn__1-6tM96NkcUhBOEjk8SDoR btn__1_GoaHrKjPXkaQLmvN_yom btn-blue__34yXHhvi2t651Fi7QF1Zjx block__3MKGyKYuSM5G_QH33nSE7J">Xem kết quả</button>
			        </div>
			    </div>
			</div>
		<script>
			$("#view-result").click(function() {
				$.ajax({
			        type: "POST",
			        url: "<c:url value="/learn/quizresult" />",
			        data: {
			        	lessionId: ${SELECTED_QUESTION.lession.id},
			        	orderDisplay: ${SELECTED_QUESTION.orderDisplay},
			        	isTrue: ${IS_TRUE},
	...
	<c:when test="${IS_DONE != null && IS_DONE == true && IS_TRUE == false}">
		<div class="container__36jSDfZIHaBt6OZ7dpxSd8">
		    <div id="quiz-shadow" class="gradient__2bgdYmOM4_blAOC2ImA1lW"></div>
		    <div class="container__2ZkNUvVpS2bqFetXuLBHoA">
	...
	<c:when test="${IS_TRUE != null && IS_TRUE == true }">
			<div class="container__36jSDfZIHaBt6OZ7dpxSd8">
			    ...
			    <div class="container__2ZkNUvVpS2bqFetXuLBHoA">
			        ...
			        <div id="answer" class="checkAnswer__3C7xBIy14T7r2Ayg-nFIAJ" style="z-index: 100;">
			            <button id="continue" data-btn="true" data-testid="check-answer-cta" class="basicBtn__1-6tM96NkcUhBOEjk8SDoR btn__1_GoaHrKjPXkaQLmvN_yom btn-blue__34yXHhvi2t651Fi7QF1Zjx block__3MKGyKYuSM5G_QH33nSE7J">Tiếp tục</button>
			        </div>
			    </div>
			</div>
		<script>
			...
			$("#continue").click(function() {
				$.ajax({
			        type: "POST",
			        url: "<c:url value="/learn/nextquiz" />",
			        data: {
			        	lessionId: ${SELECTED_QUESTION.lession.id},
			        	orderDisplay: ${SELECTED_QUESTION.orderDisplay},
			        	isTrue: ${IS_TRUE},
