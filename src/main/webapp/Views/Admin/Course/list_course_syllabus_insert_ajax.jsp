            ...
            <div class="modal-header">
                ...
                <div class="modal-title">
                    <div class="content-title">
                        <h3 class="text-center">Thêm mới giáo trình</h3>
                    </div>
                </div>
            </div>
            <form id="form-insert-syllabus" class="form-insert form-horizontal" novalidate method="POST" action="<c:url value='/Admin/Course/ListCourse/Syllabus/Insert'/>">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="hidden" class="form-control" name="course" value='${SELECTED_COURSE.id}' readonly>
                        </div>
                    </div>
                    <div class="form-group">
