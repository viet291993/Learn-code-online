            ...
            <div class="modal-header">
                ...
                <div class="modal-title">
                    <div class="content-title">
                        <h3 class="text-center">Thêm mới kiểu bài học</h3>
                    </div>
                </div>
            </div>
            <form id="form-insert" class="form-insert form-horizontal" novalidate method="POST" action="<c:url value='/Admin/Course/ListCourse/Insert'/>">
                <div class="modal-body"> 
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <label for="name" class="control-label col-sm-3">Code</label>
                        <div class="col-sm-9">
                            <input type="text" id="code" required name="code" class="form-control" placeholder="">
                        </div>
                    </div>
                </div>
