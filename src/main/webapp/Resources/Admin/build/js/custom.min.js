...
$(document).on('click', '#addQuiz', function () {
	$('#quiz').append('<div class="form-group"><input type="radio" class="col-sm-2 mt-10"  name="Quiz"><div class="col-sm-7"><input type="text" class="form-control"></div><a class="text-danger" href="javascript:void(0)"><i class="fa fa-trash deleteQuiz col-sm-3 pt-10"></i></a><input type="hidden" data-id="quizId"></div>');
});
