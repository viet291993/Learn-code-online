...
<html lang="en">
  <head>
    <title>Learn Photoshop by SKWELA</title>
    <meta charset="utf-8">
  ...
  <body>
            ...
            <ul class="navbar-nav mx-auto">
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdown04">
                  ...
                  <a class="dropdown-item" href="courses-webdes.jsp">Web Development</a>
                  <a class="dropdown-item" href="courses-pts.jsp">Javascript</a>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/photoshop.jpg);">
      <div class="container">
          ...
          <div class="col-md-12">
            ...
            <div class="mb-5 element-animate">
              <div class="row align-items-center">
                <div class="col-md-8">
                  <h1 class="mb-0">Adobe Photoshop</h1>
                  <p>By Vu Manh Hung</p>
                ...
                <div class="col-md-4">
                  <img src="images/photoshop.jpg" alt="Image placeholder" class="img-fluid">
                </div>
              </div>
            </div>
