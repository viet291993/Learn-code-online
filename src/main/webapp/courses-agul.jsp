...
<html lang="en">
  <head>
    <title>Learn AgularJS by SKWELA</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <section class="site-hero overlay" data-stellar-background-ratio="0.5" style="background-image: url(images/angularjs.jpg);">
      <div class="container">
          ...
          <div class="col-md-12">
            ...
            <div class="mb-5 element-animate">
              <div class="row align-items-center">
                ...
                <div class="col-md-4">
                  <img src="images/angularjs.jpg" alt="Image placeholder" class="img-fluid">
                </div>
              </div>
            </div>
